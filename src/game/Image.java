 ...
 */
public class Image implements Texture, Dimensionable {
	...
	public Image getSubimage(Bounds bounds) {
		return new Image(this.asBufferedImage().getSubimage(bounds.getX(), bounds.getY(), bounds.getWidth(), bounds.getHeight()));
	}
	...
	public Dimension getDimension() {
		return new Dimension(this.asBufferedImage().getWidth(), this.asBufferedImage().getHeight());
	}
